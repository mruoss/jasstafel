	...
	return (
		<Group hitStrokeWidth={0}>
			{[...Array(score.thousand)].map((_, i) => [
				<Line
					key={`thousand-${i}-1`}
					points={[...Object.values(getPoint(88 - (i + 0.7) * 5, 96)), ...Object.values(getPoint(88 - i * 5, 84))]}
					stroke="white"
					strokeWidth={strokeWidth / 3}
				/>,
				<Line
					key={`thousand-${i}-2`}
					points={[...Object.values(getPoint(88 - (i + 0.7) * 5, 84)), ...Object.values(getPoint(88 - i * 5, 96))]}
					stroke="white"
					strokeWidth={strokeWidth / 3}
				/>,
			])}
			...
			{[...Array(score.twenty)].map((_, i) => (
				<Line
					...
					points={
						(i + 1) % 5 === 0
							? [...Object.values(getPoint(88 - (i - 5) * 1.5, 4)), ...Object.values(getPoint(88 - i * 1.5, 16))]
