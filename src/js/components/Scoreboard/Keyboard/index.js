...
import { keyboardMatchFillColor } from '../../../constants/board'
	...
	<DimensionsConsumer scope={scope}>
		{({ getPoint, rotation }) => (
			...
			>
				...
				<Key
					text="0"
					bottomLeft={getPoint(43, 73)}
					topRight={getPoint(57, 87)}
					textPosition={getPoint(50, 79)}
					rotation={rotation}
					onStrike={() => addDigit(0)}
				/>
				<Key
					...
					topRight={getPoint(43, 87)}
					textPosition={getPoint(36, 79)}
					rotation={rotation}
					bgProps={{
				...
				<Key
					...
					fgProps={{
						font: '1.5rem "Font Awesome 5 Free"',
						fillStyle: complementOn ? 'green' : 'red',
					}}
					bgProps={{
						stroke: 'transparent',
						fill: 'transparent',
